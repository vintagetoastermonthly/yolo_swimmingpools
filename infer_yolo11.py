#!/usr/bin/env python3
"""
YOLOv11 inference (memory-safe, progress bar, optional random sampling)
...
Example:
  python infer_yolo11.py --weights runs/train/yolo11/weights/best.pt \
...
def parse_args():
    p = argparse.ArgumentParser("YOLOv11 inference (memory-safe)")
    p.add_argument("--weights", type=str, required=True, help="Path to .pt (e.g., best.pt, yolo11s.pt)")
